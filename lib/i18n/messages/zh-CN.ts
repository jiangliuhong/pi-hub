...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "appUpdate.releaseNotes": "Pi Hub v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    ...
    "task.create.cronExpression": "Cron 表达式",
    "task.create.cronHint": "格式：分 时 日 月 周 · 例：0 9 * * 1-5（工作日 09:00）、*/15 9-18 * * 1-5（9:00–18:00 每 15 分钟）",
    "task.create.upcoming": "接下来",
    "task.create.cronEveryMinuteWarn": "该表达式每分钟执行一次，可能产生较多 Agent 调用。",
    ...
    "task.action.copySuffix": " (副本)",
    "task.create.missingName": "请填写名称",
    "task.create.missingPrompt": "请填写 Agent 指令",
    "task.create.missingCwd": "请选择工作目录",
    "task.create.missingSession": "请选择要继续的会话",
    "task.create.providerHint": "留空使用默认",
    "task.create.modelHint": "留空使用默认",
    "task.timezone.system": "系统时区",
    "task.unsaved.title": "有未保存的修改",
    "task.unsaved.body": "关闭将丢弃当前输入，确定要关闭吗？",
    "task.unsaved.discard": "丢弃并关闭",
    "task.unsaved.keep": "继续编辑",
