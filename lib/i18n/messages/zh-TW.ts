...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "appUpdate.releaseNotes": "Pi Hub v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    ...
    "task.action.copySuffix": " (copy)",
    "task.create.missingName": "Name is required",
    "task.create.missingPrompt": "Agent instruction is required",
    "task.create.missingCwd": "Working directory is required",
    "task.create.missingSession": "Select a session to resume",
    "task.create.providerHint": "Leave empty for default",
    "task.create.modelHint": "Leave empty for default",
    "task.timezone.system": "System timezone",
    "task.unsaved.title": "Unsaved changes",
    "task.unsaved.body": "Closing will discard your input. Close anyway?",
    "task.unsaved.discard": "Discard & close",
    "task.unsaved.keep": "Keep editing",
  },
};
